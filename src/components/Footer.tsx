  ...
  return (
    <footer className="border-t border-white/5 bg-[#040404] px-6 py-10">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        {/* Logo + tagline */}
        <div>
          <div className="text-sm font-semibold tracking-wider text-white/70 uppercase mb-1">
            Polymarket Search
          </div>
        ...
        {/* Disclaimer */}
        <div className="text-[9px] text-white/15 max-w-xs leading-relaxed">
          Not affiliated with Polymarket. For informational purposes only.
